...
namespace Infrastructure.Persistence.Configuration
{
    public class UserConfiguration : IEntityTypeConfiguration<UserAggregate>
    {
        public void Configure(EntityTypeBuilder<UserAggregate> builder)
        {
            ...
            builder.Property(x => x.FirstName).HasColumnName("first_name").HasColumnType("varchar(250)");
            builder.Property(x => x.LastName).HasColumnName("last_name").HasColumnType("varchar(250)");
            builder.Property(x => x.Email).HasColumnName("email").HasColumnType("varchar(250)");
